...
class PlayerLayoutPreferences(
    ...
    companion object {
        ...
        const val DEFAULT_TOP_RIGHT = "decoder,speed,chapters,subtitles,sleep_timer,more"
        const val DEFAULT_BOTTOM_RIGHT = "aspect_ratio,pip,lock"
        const val DEFAULT_BOTTOM_LEFT = "audio_track,rotate,frame_nav"
        const val DEFAULT_PORTRAIT_BOTTOM = "subtitles,audio_track,lock,rotate,more"
        const val DEFAULT_CONTROLS_TAB = "speed,decoder,aspect_ratio,pip,sleep_timer,rotate,frame_nav,chapters,repeat_mode,shuffle"
    }
